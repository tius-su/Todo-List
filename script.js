...
function renderWidgets() {
    ...
    const todayOverview = document.getElementById("task-overview-today");
    const routineOverview = document.getElementById("task-overview-routine");
    const weekOverview = document.getElementById("task-overview-week");
    const profileLabel = document.getElementById("profile-user-label");
    if (todayOverview) todayOverview.textContent = todayTasks;
    if (routineOverview) routineOverview.textContent = getTodayRecurringTasks().length;
    if (weekOverview) weekOverview.textContent = completedThisWeek;
    if (profileLabel) profileLabel.textContent = currentUserId;
}
